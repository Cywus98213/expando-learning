...
const BlogCard = ({
  ...
  return (
    <Link
      className="flex flex-col w-full aspect-[4/3] border border-gray-200 rounded-xl p-4 bg-white shadow"
      href={`/blogs/${id}`}
    >
      <Image
        src={imageUrl}
      ...
      <article className="h-full mt-2">
        <div className="flex flex-col justify-between h-full">
          <header className="flex flex-col gap-1">
            <h3 className="font-bold text-3xl md:text-2xl mb-2">{title}</h3>
